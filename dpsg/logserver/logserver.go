...
func (self *LogServices) LogTaobaoPayResult(msg *proto.TaobaoPayLog, result *proto.TaobaoPayLogResult) error {
	result = &proto.TaobaoPayLogResult{}
	self.getDb().Exec("LogTaobaoPay", msg.CharId, msg.ChannelId, msg.TradeTime, msg.TradeError, msg.TradeEnd, msg.TradeNumber, msg.ItemName, msg.TotoalPee)
	return nil
}
